(function(angular) {
     ...
     */
    var paths = {
        login: '/visitors/sign_in.json',
        logout: '/visitors/sign_out.json',
        register: '/visitors.json',
        sendResetPasswordInstructions: '/visitors/password.json',
        resetPassword: '/visitors/password.json'
    };
